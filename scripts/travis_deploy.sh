...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "ChristianLieven/memote-e-coli" ]]; then
...
echo "Your new report will be visible at https://ChristianLieven.github.io/memote-e-coli in a moment."
